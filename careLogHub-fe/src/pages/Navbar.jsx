...
const Navbar = () => {
    ...
    return (
        <>
            {/* Navbar Header */}
            <div className="lg:hidden flex items-center justify-between bg-gray-800 p-4 fixed top-0 left-0 w-full z-50">
            ...
            <div className="hidden lg:flex lg:flex-col lg:w-64 bg-gray-800 text-white fixed inset-y-0 left-0">
